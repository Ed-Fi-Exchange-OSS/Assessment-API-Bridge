...
By default, the Ed-Fi web site in IIS is set to run with HTTPS on port 444 with
self-signed certificate and uses computer name in host header. 
The Center for Internet Security (CIS) recommends that 

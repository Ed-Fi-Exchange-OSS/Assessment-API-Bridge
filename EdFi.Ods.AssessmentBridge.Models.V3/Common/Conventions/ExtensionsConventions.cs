...
// NOTE: Not needed for shim --> using EdFi.Ods.Common.Models.Domain;
...
namespace EdFi.Ods.Common.Conventions
{
    public static class ExtensionsConventions
    {
        ...
        {
            return assemblyName.StartsWith(Namespaces.Extensions.BaseNamespace);
        }
        ...
        {
            string extensionSegment = string.IsNullOrEmpty(extensionName)
                ? string.Empty
                : $".{extensionName}";

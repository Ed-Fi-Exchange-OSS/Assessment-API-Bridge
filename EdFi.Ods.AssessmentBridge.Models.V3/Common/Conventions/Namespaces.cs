...
namespace EdFi.Ods.Common
{
    public static class Namespaces
    {
        ...
        {
            public static string BaseNamespace => "EdFi.Ods.BulkLoad";

            public static string Aggregates => $"{BaseNamespace}.Core.Controllers.Aggregates";

            public static string Common => $"{BaseNamespace}.Common";
        }
